                        ...
                        @else
                            ...
                            <div class="flex gap-2 mt-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                @if($message->user_id === Auth::id())
                                    ...
                                    <button wire:click="confirmDeleteMessage({{ $message->id }})" class="text-xs text-red-600 dark:text-red-400 hover:underline flex items-center gap-1">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Are you sure you want to delete this message?</p>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-3">
                    <button wire:click="cancelDeleteMessage" 
