            ...
            @if($showBulkPanel)
                <div class="sticky top-0 z-10 bg-blue-50 dark:bg-blue-900/20 border-b border-blue-200 dark:border-blue-800 p-4">
                    ...
                    <div class="flex justify-end space-x-2">
                        <button onclick="if(confirm('Are you sure? This will delete all selected items and their children.')) { @this.call('bulkDelete') }" class="px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg">
                            Delete Selected
                        </button>
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-start justify-between mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button onclick="if(confirm('Are you sure? This will delete all child items too.')) { @this.call('deleteItem', {{ $this->selectedItem->id }}) }" class="p-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4 shadow-xl">
            <div class="flex items-center mb-4">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Delete Backlog Item</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Are you sure you want to delete this backlog item?</p>
                </div>
            </div>
            
            <div class="bg-yellow-50 dark:bg-yellow-900 border border-yellow-200 dark:border-yellow-700 rounded-md p-3 mb-4">
                <p class="text-sm text-yellow-800 dark:text-yellow-200">
                    <strong>Warning:</strong> This action cannot be undone. All child items will also be deleted.
                </p>
            </div>

            <div class="flex justify-end space-x-3">
                <button wire:click="cancelDeleteItem" 
