<div class="kanban-statuses flex flex-col bg-gray-50/60 dark:bg-gray-900/40 rounded-xl border border-gray-200 dark:border-gray-700">
    ...
    <div class="status-container min-h-[240px] px-3 pb-3 space-y-3"
        ...
        @if($status['add_ticket'])
            <a class="create-record hover:cursor-pointer mt-1 inline-flex items-center gap-1 text-xs px-2 py-1 rounded-md bg-white/60 dark:bg-gray-800/60 hover:bg-white dark:hover:bg-gray-800 border border-dashed border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300"
